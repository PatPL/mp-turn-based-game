...
public class Test {
    ...
    private String letter (Unit unit) {
        ...
        String teamLetter = "R";
        if (unit.getTeam () == 2) {
            teamLetter = "B";                                          //A - Archer
        }
        if (unit.getName ().equals ("Archer")) {
            return "[" + teamLetter + "A]    ";            //S - Swordsman
        }
        if (unit.getName ().equals ("Swordsman")) {
            return "[" + teamLetter + "S]    ";         //K - Knight
        }
        if (unit.getName ().equals ("Knight")) {
            return "[" + teamLetter + "K]    ";            //O - Empty
        } else {
            return "[O]    ";                                                             //R - Red  ; B - Blue
        }
    }
